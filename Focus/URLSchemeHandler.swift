...
class URLSchemeHandler {
    ...
    private let urlSchemes: [Platform: [String]] = [
        ...
        .twitter: ["twitter://", "twitter://www.twitter.com/", "twitter://twitter.com/"],
...
extension URLSchemeHandler {
    func formatURL(for platform: Platform, query: String) -> String {
        ...
        case .twitter:
            return "https://twitter.com/search?q=\(query.addingPercentEncoding(withAllowedCharacters: .urlQueryAllowed) ?? query)"
        case .google:
    ...
    func formatNativeAppURL(for platform: Platform, query: String) -> String? {
        ...
        case .twitter:
            return "twitter://twitter.com/search?q=\(query.addingPercentEncoding(withAllowedCharacters: .urlQueryAllowed) ?? query)"
        case .google:
